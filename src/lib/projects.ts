import minesweeperCover from "$lib/assets/minesweeper.jpeg";
import minesweeperVideo from "$lib/assets/minesweeper.mp4";
import donequickCover from "$lib/assets/donequick.jpeg";
import donequickVideo from "$lib/assets/donequick.mp4";
import mcsrrankedstatsCover from "$lib/assets/mcsrrankedstats.jpeg";
import mcsrrankedstatsVideo from "$lib/assets/mcsrrankedstats.mp4";
import ucsdcoursesCover from "$lib/assets/ucsdcourses.jpeg";
import ucsdcoursesVideo from "$lib/assets/ucsdcourses.mp4";
import joyspringCover from "$lib/assets/joyspring.jpeg";
